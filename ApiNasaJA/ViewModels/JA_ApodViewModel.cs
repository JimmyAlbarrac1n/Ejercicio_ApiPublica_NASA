...
namespace ApiNasaJA.ViewModels
{
    public class JA_ApodViewModel : INotifyPropertyChanged
    {
        ...
        private JA_ApodService service;
        public JA_ApodService Service
        {
            get
            {
                if (service == null)
                {
                    service = new JA_ApodService();
                }
                return service;
            }
        }
        ...
        {
            JA_Apod dto = await Service.GetImage(day);
            if (dto == null)
            {
